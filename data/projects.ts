...
export const projects: Project[] = [
    {
        ...
        appstoreUrl:
            'https://apps.apple.com/us/app/general-provision/id6444879814',
        tech: [
            'Swift',
            'CoreBluetooth',
            'CoreLocation',
    ...
    },
    {
        ...
        details: [
            'Developed a comprehensive recruitment system connecting employers and candidates, featuring a matching algorithm with score calculation to streamline the hiring process.',
            'Implemented a secure payment system via Stripe and integrated a real-time chat feature using Socket.io, enabling seamless communication between employers and candidates.',
            'Managed time and work tracking and integrated background checks through the Checkr API to ensure thorough candidate vetting.',
        ],
        tech: [
            'Nest.js',
            'Prisma',
    ...
    },
    {
        ...
        details: [
            'Managed a team of two developers, overseeing the design, development, and deployment of iOS applications with advanced multimedia features like video/audio recording, editing, and processing.',
            'Handled the Node.js server backend, ensuring seamless integration and optimal performance for mobile app features.',
            'Implemented a unique messaging system where users could send messages to the future, accessible only at specific locations and times.',
        ],
        tags: ['All', 'iOS', 'Full-stack'],
    ...
    },
    {
        ...
        appstoreUrl:
            'https://apps.apple.com/gb/app/snapshop-republic/id1309079895',
    },
    {
        id: 'fixir',
        name: 'Fixir',
